                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                            ...
                            <option value="مواطن" {{ old('status', $student->status) == 'مواطن' ? 'selected' : '' }}>مواطن</option>
                            <option value="لاجئ" {{ old('status', $student->status) == 'لاجئ' ? 'selected' : '' }}>لاجئ</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        ...
                        <select class="form-select @error('academic_year') is-invalid @enderror" id="academic_year" name="academic_year" required>
                            ...
                            @for ($year = 2023; $year <= 2030; $year++)
                                @php
                                    ...
                                    $value = "$year-$nextYear";
                                @endphp
                                <option value="{{ $value }}" {{ old('academic_year', $student->academic_year) == $value ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endfor
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control @error('entry_date') is-invalid @enderror"
                                   ...
                                   value="{{ old('entry_date', $student->entry_date) }}" required>
                            @error('entry_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('guardian_national_id') is-invalid @enderror"
                                   ...
                                   value="{{ old('guardian_national_id', $student->guardian_national_id) }}"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('transferred_from') is-invalid @enderror"
                                   ...
                                   value="{{ old('transferred_from', $student->transferred_from) }}"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('transferred_to') is-invalid @enderror"
                                   ...
                                   value="{{ old('transferred_to', $student->transferred_to) }}"
